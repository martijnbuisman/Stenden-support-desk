...
if ($user->hasPermission('admin')) {
    //code
    echo "<h1>Autorisatie -> Gebruiker -> Nieuw -> Werknemer</h1>";
        ...
        if (Token::check(Input::get('token'))) {
            ...
            if ($validation->passed()) {
                ...
                try {
                    ...
                    Session::flash('home', 'Employee succesfully created!');
                    Redirect::to('index.php?page=autorisation_user_new_employee');
                } catch (Exception $ex) {
                    die($ex->getMessage());
                }
            } else {
